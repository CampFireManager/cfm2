                ...
                <div id="Talk_<!--SM:$object.intTalkID:SM-->">
                    ...
                    <div id="intTalkID">
                        <div>
                            ...
                            <p><img src="<!--SM:$SiteConfig.baseurl:SM-->media/images/alert-triangle-grey.png" /> <strong><!--SM:if (isset($Object_User.current) && isset($Object_User.current.isWorker) && ($Object_User.current.isWorker || $Object_User.current.isAdmin)):SM--><a href="<!--SM:$SiteConfig.baseurl:SM-->talk/<!--SM:$object.intOverlapID:SM-->"><!--SM:/if:SM-->Double Booked<!--SM:if (isset($Object_User.current) && isset($Object_User.current.isWorker) && ($Object_User.current.isWorker || $Object_User.current.isAdmin)):SM--> with <!--SM:$object.intOverlapID:SM-->!</a><!--SM:/if:SM--></strong></p><!--SM:/if:SM-->
                        </div>
                    </div>

                    <!--SM:include file="Elements/TextBox.tpl" field='strTalk' placeholder=$object.labels.strTalk_Placeholder|default:'' label=$object.labels.strTalk|default:'' edit=$object.isEditable.strTalk|default:array() current=$object.strTalk|default:array():SM-->
