...
{foreach $Collection_Timetable as $Timetable}
<table>
    <tr>
        <th>&nbsp;</th>
...
{/if}
{foreach $xaxis as $xaxis_value}
        <td class="talk{if $Timetable.arrTimetable[$xaxis_value@key][$yaxis_value@key]['isNow'] == 1} slot_now{elseif $Timetable.arrTimetable[$xaxis_value@key][$yaxis_value@key]['isNext'] == 1} slot_next{/if}">
