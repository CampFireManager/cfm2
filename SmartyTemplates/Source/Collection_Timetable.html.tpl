...
<table>
    <tr>
        <th>&nbsp;</th>
{if $Collection_Timetable.0.x_axis == 'room'}
{assign var="xaxis" value=$Collection_Timetable.0.arrRooms}
{assign var="yaxis" value=$Collection_Timetable.0.arrSlots}
{else}
{assign var="xaxis" value=$Collection_Timetable.0.arrSlots}
{assign var="yaxis" value=$Collection_Timetable.0.arrRooms}
{/if}
...
{if $Collection_Timetable.0.y_axis == 'room'}
...
{foreach $xaxis as $xaxis_value}
        <td class="talk">
{include file="Timetable_TalkCell.tpl" cell=$Collection_Timetable.0.arrTimetable[$xaxis_value@key][$yaxis_value@key]}
        </td>
{/foreach}
    </tr>
{/foreach}
