...
class Object_RoomTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testGetAllRooms()
    {
        ...
        $this->assertTrue($arrRooms[1]->getKey('strRoomName') == 'Room A');
        ...
        $this->assertTrue($arrRooms[2]->getKey('strRoomName') == 'Room B');
        ...
        $this->assertTrue($arrRoom['strRoomName'] == 'Room C');
    ...
    public function testGetAllRoomsByRoomSize()
    {
        ...
        $this->assertTrue($arrRooms[0]->getKey('strRoomName') == 'Room A');
        ...
        $this->assertTrue($arrRooms[1]->getKey('strRoomName') == 'Room C');
        ...
        $this->assertTrue($arrRoom['strRoomName'] == 'Room B');
