...
if (class_exists('CFM2_Sniffs_Commenting_FileCommentSniff', true) === false) {
    $error = 'Class CFM2_Sniffs_Commenting_FileCommentSniff not found';
    throw new PHP_CodeSniffer_Exception($error);
}
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class CFM2_Sniffs_Commenting_ClassCommentSniff extends CFM2_Sniffs_Commenting_FileCommentSniff
{
