...
class CFM2_Sniffs_Commenting_FileCommentSniff implements PHP_CodeSniffer_Sniff
{
    ...
    {
        $docBlock    = (get_class($this) === 'CFM2_Sniffs_Commenting_FileCommentSniff') ? 'file' : 'class';
